...
const pages = [
  ...
  {
    path: "pages/joinImages/joinPreview",
    style: {
...
const subPackages = [
  {
    ...
    pages: [
      {
        path: "watermark/index/index",
        style: {
          navigationBarTitleText: "短视频去水印小帮手",
          navigationBarBackgroundColor: "#99CCFF",
          navigationBarTextStyle: "white"
        }
      },
      {
        path: "watermark/video/video",
        style: {
          navigationBarTitleText: "无水印视频预览",
...
const S = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = b, P = I('{\n    "address": [\n        "127.0.0.1",\n        "192.168.1.104"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/app_install/HbuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), T = I('[{"provider":"aliyun","spaceName":"mztool","spaceId":"mp-910c5550-c8fd-465a-8157-b680fb490467","clientSecret":"ZdeOZFD8cTUIjpvYmmZ58g==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__DD59294";
} catch (e2) {
